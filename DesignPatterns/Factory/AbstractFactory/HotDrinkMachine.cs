...
namespace DesignPatterns.Factory.AbstractFactory
{
    ...
    {
        public enum AvailableDrink // violates open-closed, we need this for commented out code
        {
            Coffee, Tea
        }
        ...
        public HotDrinkMachine()
        {
            ...
            foreach (var t in typeof(HotDrinkMachine).Assembly.GetTypes())
            {
                ...
                {
                    namedFactories.Add(Tuple.Create(t.Name.Replace("Factory", string.Empty), (IHotDrinkFactory)Activator.CreateInstance(t)));
                }
            }
        }
